...
<script src="/efids_admin.js"></script>
	...
	<div class="row mt-4 mr-2 ml-1">
		...
		<div class="tab-content" id="myTabContent">
		  ...
		  <div class="text-right my-2">
		  			<button id="filebtn" type="button" class="btn btn-secondary mr-auto filebtn"><i class="fas fa-file-upload"></i> Upload file</button>
					<button id="createbtn" type="button" class="btn btn-primary mr-auto createbtn"><i class="fa fa-plus"></i> New</button>
					<button id="refreshbtn" type="button" class="btn btn-success mr-auto refreshbtn"><i class="fa fa-refresh"></i> Refresh</button>
		    		<button id="sync" type="button" class="btn btn-warning text-white mr-auto sync"><i class="fas fa-file-download"></i> Sync</button>
		    </div>
